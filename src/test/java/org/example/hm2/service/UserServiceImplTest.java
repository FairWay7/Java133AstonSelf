...
public class UserServiceImplTest {
    ...
    void getUserByEmail() {
        ...
        when(userDAO.getByEmail(email)).thenReturn(Optional.of(expectedUser));
    ...
    void updateUser() {
        ...
        when(userDAO.getByEmail(newEmail)).thenReturn(Optional.of(user));
        ...
        verify(userDAO).getByEmail(newEmail);
